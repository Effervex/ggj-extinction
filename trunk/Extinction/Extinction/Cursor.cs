    ...
    public class Cursor : DrawableGameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Game.IsActive)
            {
                ...
                Viewport vp = ExtinctionGame.instance.GraphicsDevice.Viewport;
        ...
        public Ray CalculateCursorRay(Matrix projectionMatrix, Matrix viewMatrix)
        {
            try
            {
                ...
                Vector3 nearPoint = ExtinctionGame.instance.GraphicsDevice.Viewport.Unproject(nearSource,
                    projectionMatrix, viewMatrix, Matrix.Identity);

                Vector3 farPoint = ExtinctionGame.instance.GraphicsDevice.Viewport.Unproject(farSource,
                    projectionMatrix, viewMatrix, Matrix.Identity);
